...
$(function(){
	var listcnt = $("#lp").children("tr").length;
...
<body>
	...
	<nav style="float: right">
	  <ul class="pagination">
	    <li><a href="?page=1" aria-label="Previous">首页</a></li>
	    <li><a href="?page=${pageInfo.pre}">上一页</a></li>
	    <li><a href="?page=${pageInfo.next}">下一页</a></li>
	    <li><a href="?page=${pageInfo.last}" aria-label="Next">尾页</a></li>
	  </ul>
	</nav>
